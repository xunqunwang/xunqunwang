...
import (
	...
	"go-online/lib/net/http/blademaster/render"
...
var (
	...
	<meta http-equiv="refresh" content="0;uri=http://www.xunqunwang.com/">
	</html>`)
...
func TestRedirect(t *testing.T) {
	c := &http.Client{
		CheckRedirect: func(req *http.Request, via []*http.Request) error {
			req.Header["Referer"] = []string{"http://www.xunqunwang.com/"}
			return nil
		},
	}
...
func TestCORSPreflight(t *testing.T) {
	...
	origin := "ccc.xunqunwang.com"
	c := &http.Client{}
	req, err := http.NewRequest("OPTIONS", uri(SockAddr, "/get"), nil)
	if err != nil {
		t.Fatalf("Failed to build request: %s", err)
	}
	req.Header.Set("Referer", "http://www.xunqunwang.com/")
...
func TestCORSFailed(t *testing.T) {
	...
	req.Header.Set("Referer", "http://www.xunqunwang2.com/")
	req.Header.Set("Origin", "ccc.xunqunwang2.com")
	resp, err := c.Do(req)
	if err != nil {
		t.Fatalf("Failed to send request: %s", err)
	}
...
func TestCSRF(t *testing.T) {
	...
	allowed := []string{
		"http://www.xunqunwang.com/",
		"http://www.biligame.com/",
		"http://www.im9.com/",
		"http://www.acg.tv/",
		"http://www.hdslb.com/",
		"http://www.xunqunwang.co/",
