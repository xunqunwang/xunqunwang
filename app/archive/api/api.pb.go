...
import go_common_library_time "go-online/lib/time"
...
type Arc struct {
	...
	PubDate go_common_library_time.Time `protobuf:"varint,8,opt,name=PubDate,proto3,casttype=go-online/lib/time.Time" json:"pubdate"`
	// 用户提交稿件的时间 一般不对外展示 时间戳格式
	Ctime go_common_library_time.Time `protobuf:"varint,9,opt,name=Ctime,proto3,casttype=go-online/lib/time.Time" json:"ctime"`
	// 稿件简介
	Desc string `protobuf:"bytes,10,opt,name=Desc,proto3" json:"desc"`
	// 稿件状态，>=0为前台用户可见状态，其他值详见 http://info.xunqunwang.co/pages/viewpage.action?pageId=3686597#id-%E7%A8%BF%E4%BB%B6%E5%AD%97%E6%AE%B5%E6%9E%9A%E4%B8%BE%E5%80%BC%E5%B1%9E%E6%80%A7%E8%AF%B4%E6%98%8E-%E7%A8%BF%E4%BB%B6%E7%8A%B6%E6%80%81state&access
...
type Page struct {
	...
	// 视频的来源，99%为vupload=寻群网自己的，少部分为腾讯（qq）、湖南tv(hunan)
